  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 text-center">
        ...
        <p className="text-sm text-[var(--color-text-secondary)] font-mono">{url}</p>
      </div>
      ...
      <div className="no-print flex justify-center mt-8">
        <button
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-medium bg-[var(--color-primary)] text-white hover:bg-[var(--color-primary-dark)] transition-colors"
        >
